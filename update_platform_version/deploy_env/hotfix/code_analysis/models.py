...
class AnalysisTask(models.Model):
    ...
    STATUS_CHOICES = [
        ("pending", "待执行"), ("queued", "排队中"), ("fetching", "获取代码中"), ("machine_analyzing", "机器分析中"),
        ("ai_analyzing", "AI分析中"), ("generating_tests", "生成测试报告中"),
        ("completed", "已完成"), ("degraded", "降级完成"), ("partial", "部分完成"), ("failed", "失败"), ("cancelled", "已取消"),
    ]
...
class AnalysisTaskExecutionLog(models.Model):
    ...
    EVENT_CHOICES = [
        ...
        ("completed", "已完成"), ("degraded", "降级完成"), ("partial", "部分完成"), ("failed", "执行失败"),
        ("cancelled", "已取消"),
    ]
