...
const LEGACY_EXACT_EN_MAP: Record<string, string> = {
  ...
  '操作日志自动清理设置': 'Operation Log Auto Cleanup Settings',
  '系统会每天凌晨 3 点自动清理超过保留天数的操作日志，默认保留 7 天。': 'The system automatically removes operation logs older than the retention period at 03:00 every day. The default retention period is 7 days.',
  '系统会每天自动清理超过保留天数的操作日志，默认保留 7 天。': 'The system automatically removes operation logs older than the retention period every day. The default retention period is 7 days.',
  '自动清理保留天数': 'Auto cleanup retention days',
  '7天（默认）': '7 days (default)',
  '15天': '15 days',
  '30天': '30 days',
  '自定义': 'Custom',
  '自定义保留天数': 'Custom retention days',
  '当前生效保留天数：': 'Current retention days:',
  '您当前仅有查看权限，不能修改自动清理设置。': 'You currently have read-only access and cannot modify the auto cleanup settings.',
  ...
  '立即清理': 'Clean Up Now',
  '立即清理操作日志': 'Clean up operation logs now',
  '系统将立刻删除超过当前保留天数的操作日志，是否继续？': 'The system will immediately delete operation logs older than the current retention period. Do you want to continue?',
  ...
  '文档脱敏管理': 'Document Anonymization',
  '检测并移除文档中的敏感个人信息（PII），如手机号、身份证号、银行卡号等。': 'Detect and remove Personally Identifiable Information (PII) from documents, such as phone numbers, ID cards, bank card numbers, etc.',
  '知识库文档': 'Knowledge Base Documents',
  '需求文档': 'Requirement Documents',
  '搜索文档标题': 'Search document title',
  '文档标题': 'Document Title',
  '脱敏状态': 'Anonymization Status',
  '已脱敏': 'Anonymized',
  '未脱敏': 'Not Anonymized',
  '待脱敏': 'Pending',
  '脱敏时间': 'Anonymized At',
  '执行脱敏': 'Anonymize',
  '脱敏预览': 'Anonymization Preview',
  '共检测到': 'Detected',
  '处敏感信息': 'pieces of PII',
  '检测到的敏感信息：': 'Detected PII:',
  '置信度': 'Confidence',
  '脱敏后文本预览：': 'Anonymized text preview:',
  '确认脱敏': 'Confirm Anonymization',
  '执行脱敏后将永久修改文档内容，此操作不可撤销。是否继续？': 'After anonymization, the document content will be permanently modified. This action cannot be undone. Continue?',
  '脱敏完成': 'Anonymization Complete',
  '脱敏失败': 'Anonymization Failed',
  '预览失败': 'Preview Failed',
  '预览请求失败': 'Preview request failed',
  '脱敏请求失败': 'Anonymization request failed',
  '规则管理': 'Rule Management',
  '脱敏规则': 'Anonymization Rules',
  '搜索规则名称': 'Search rule name',
  '新增规则': 'Add Rule',
  '初始化默认规则': 'Init Default Rules',
  '规则名称': 'Rule Name',
  '实体类型': 'Entity Type',
  '显示标签': 'Display Label',
  '正则表达式': 'Regex Pattern',
  '确定删除此规则？': 'Are you sure to delete this rule?',
  '编辑规则': 'Edit Rule',
  '如：chinese_phone': 'e.g. chinese_phone',
  '如：PHONE_NUMBER': 'e.g. PHONE_NUMBER',
  '如：手机号': 'e.g. Phone Number',
  ...
  '保存失败': 'Save failed',
  '规则已保存': 'Rules saved',
  '自定义关键词匹配': 'Custom Keyword Matching',
  '添加需要精确匹配的关键词，并指定替换词。留空则使用 <关键词> 作为默认替换词。': 'Add keywords for exact matching and specify replacement words. Leave empty to use <Keyword> as default.',
  '关键词': 'Keyword',
  '替换词（留空默认 <关键词>）': 'Replacement (empty = <Keyword>)',
  '添加关键词': 'Add Keyword',
  '预设敏感信息类型': 'Preset Sensitive Info Types',
  '上传成功，已添加 ': 'Uploaded, added ',
  ' 个文档': ' document(s)',
  '上传失败': 'Upload failed',
  '未成功添加任何文档': 'No documents were added',
  '初始化失败': 'Initialization failed',
  '默认规则初始化完成': 'Default rules initialized',
  '规则测试': 'Rule Test',
  '输入测试文本': 'Enter test text',
  '执行测试': 'Run Test',
  '共匹配到': 'Matched',
  '处': 'occurrences',
  ...
  '位置': 'Position',
  '文件脱敏': 'File Anonymization',
  '上传文档，配置脱敏规则，执行脱敏并下载脱敏后的文件。': 'Upload documents, configure anonymization rules, execute and download anonymized files.',
  '文档列表': 'Document List',
  ...
  '报告': 'Report',
  '确定删除此文档？': 'Are you sure to delete this document?',
  '下载失败': 'Download failed',
  '下载的文件为空': 'Downloaded file is empty',
  '配置脱敏规则': 'Configure Anonymization Rules',
  '预设PII类型': 'Preset PII Types',
  '自定义关键词': 'Custom Keywords',
  '每行一个关键词，系统将精确匹配并替换为 <KEYWORD>': 'One keyword per line, exact match and replace with <KEYWORD>',
  '脱敏报告': 'Anonymization Report',
  '按类型统计': 'Statistics by Type',
  '数量': 'Count',
  '示例': 'Examples',
  '详细列表（前100条）': 'Detail List (top 100)',
  '类型标识': 'Type Code',
  '显示名称': 'Display Name',
  '已启用': 'Enabled',
  '已禁用': 'Disabled',
  '脱敏中': 'Anonymizing',
  '脱敏模板': 'Anonymization Templates',
  '模板名称': 'Template Name',
  '模板说明': 'Template Description',
  '新增模板': 'Add Template',
  '编辑模板': 'Edit Template',
  '新增模板成功': 'Template created',
  '初始化脱敏模板': 'Init Default Templates',
  '初始化脱敏模板完成': 'Default templates initialized',
  '确定删除此模板？': 'Are you sure to delete this template?',
  '输入模板名称': 'Enter template name',
  '输入模板说明': 'Enter template description',
  '预设类型': 'Preset Types',
  '关键词数': 'Keywords',
  '应用模板': 'Apply Template',
  '应用模板（可多选）': 'Apply Templates (Multi-select)',
  '选择模板以快速填充规则': 'Select a template to fill rules',
  '已应用模板': 'Template applied',
  '已应用': 'Applied',
  '个模板的规则': 'template(s) rules merged',
  '应用选中模板': 'Apply Selected',
  '模板匹配规则预览': 'Template Rules Preview',
  '预设敏感类型': 'Preset Sensitive Types',
  '所选模板暂无匹配规则': 'No rules in selected templates',
  '新增规则成功': 'Rule created',
  ...
  '请先选择要删除的接口用例': 'Select the interface cases to delete first',
  ...
  '批量删除用例失败': 'Failed to batch delete cases',
  '批量删除接口用例失败': 'Failed to batch delete interface cases',
