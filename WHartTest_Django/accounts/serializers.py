...
class ContentTypeSerializer(serializers.ModelSerializer):
    ...
    def get_model_cn(self, obj):
        ...
        try:
            ...
            app_model_translations = {
                ...
                "code_analysis.gitlabconnection": "GitLab连接",
                "code_analysis.projectrepository": "项目代码仓库",
                "code_analysis.usergitlabcredential": "GitLab用户凭据",
                "code_analysis.analysistask": "代码审查任务",
                "code_analysis.analysistaskexecutionlog": "代码审查执行日志",
                "code_analysis.testrequirementdraft": "代码审查测试需求",
    ...
    def get_model_en(self, obj):
        ...
        model_translations = {
            ...
            "code_analysis.gitlabconnection": "GitLab Connection",
            "code_analysis.projectrepository": "Project Repository",
            "code_analysis.usergitlabcredential": "GitLab User Credential",
            "code_analysis.analysistask": "Code Review Task",
            "code_analysis.analysistaskexecutionlog": "Code Review Execution Log",
            "code_analysis.testrequirementdraft": "Code Review Test Requirement",
            "skills.skill": "Skill",
